(function (root) {
    var bundle = function () {
        ...
        5: [function (require, module, exports) {
            ...
            var kindAliases = {audioinput: "Audio Input", audiooutput: "Audio Output"};
        ...
        6: [function (require, module, exports) {
            ...
            var BACKOFF_CONFIG = {factor: 1.1, initialDelay: 1, maxDelay: 3e4, randomisationFactor: .5};
            ...
            var Call = function (_super) {
                ...
                function Call(config, options) {
                    ...
                    _this._options = {
                        MediaHandler: PeerConnection, offerSdp: null, shouldPlayDisconnect: function () {
                            return true
                        }
                    };
                    ...
                    _this._onMediaFailure = function (type) {
                        var _a = Call.MediaFailure, ConnectionDisconnected = _a.ConnectionDisconnected,
                            ConnectionFailed = _a.ConnectionFailed, IceGatheringFailed = _a.IceGatheringFailed,
                    ...
                    _this._mediaHandler.ondisconnected = function (msg) {
                        _this._log.info(msg);
                        _this._publisher.warn("network-quality-warning-raised", "ice-connectivity-lost", {message: msg}, _this);
                    ...
                    _this._mediaHandler.onreconnected = function (msg) {
                        _this._log.info(msg);
                        _this._publisher.info("network-quality-warning-cleared", "ice-connectivity-lost", {message: msg}, _this);
                    ...
                    _this._mediaHandler.onclose = function () {
                        _this._status = Call.State.Closed;
                        if (_this._options.shouldPlayDisconnect && _this._options.shouldPlayDisconnect() && !_this._isCancelled) {
                ...
                Call.prototype.accept = function (options) {
                    ...
                    var connect = function () {
                        ...
                        var onAnswer = function (pc, reconnectToken) {
                            ...
                            var _a = getPreferredCodecInfo(_this._mediaHandler.version.getSDP()),
                                codecName = _a.codecName, codecParams = _a.codecParams;
                    ...
                    promise.then(function () {
                        _this._publisher.info("get-user-media", "succeeded", {data: {audioConstraints: audioConstraints}}, _this);
                        connect()
                    }, function (error) {
                        var twilioError;
            ...
            var Device = function (_super) {
                ...
                function Device(token, options) {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        return [4, this._makeCall(customParameters, {
                    ...
                    _this._updateSinkIds = function (type, sinkIds) {
                        ...
                        return promise.then(function () {
                            _this._publisher.info("audio", type + "-devices-set", {audio_device_ids: sinkIds}, _this._activeCall)
                        }, function (error) {
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    ...
                                    _a = this;
                                    return [4, this._makeCall(options.params || {}, {rtcConfiguration: options.rtcConfiguration})];
                                case 1:
                ...
                Device.prototype._setupAudioHelper = function () {
                    ...
                    this._audio.on("deviceChange", function (lostActiveDevices) {
                        ...
                        _this._publisher.info("audio", "device-change", {lost_active_device_ids: deviceIds}, activeCall);
                        if (activeCall) {
                ...
                Device.prototype._setupPublisher = function () {
                    ...
                    var publisherOptions = {
                        ...
                        log: this._log,
                        metadata: {app_name: this._options.appName, app_version: this._options.appVersion}
                    };
        ...
        11: [function (require, module, exports) {
            ...
            (function (GeneralErrors) {
                ...
                var CallCancelledError = function (_super) {
                    __extends(CallCancelledError, _super);

                    function CallCancelledError(messageOrError, error) {
                        var _this = _super.call(this, messageOrError, error) || this;
                        _this.causes = ["The incoming call was cancelled because it was not answered in time or it was accepted/rejected by another application instance registered with the same identity."];
                        _this.code = 31008;
            ...
            (function (UserMediaErrors) {
                var PermissionDeniedError = function (_super) {
                    ...
                    function PermissionDeniedError(messageOrError, error) {
                        var _this = _super.call(this, messageOrError, error) || this;
                        _this.causes = ["The user denied the getUserMedia request.", "The browser denied the getUserMedia request."];
                        _this.code = 31401;
                        ...
                        _this.solutions = ["The user should accept the request next time prompted. If the browser saved the deny, the user should change that permission in their browser.", "The user should to verify that the browser has permission to access the microphone at this address."];
                ...
                var AcquisitionFailedError = function (_super) {
                    __extends(AcquisitionFailedError, _super);

                    function AcquisitionFailedError(messageOrError, error) {
                        var _this = _super.call(this, messageOrError, error) || this;
                        _this.causes = ["NotFoundError - The deviceID specified was not found.", "The getUserMedia constraints were overconstrained and no devices matched."];
                        _this.code = 31402;
                        ...
                        _this.solutions = ["Ensure the deviceID being specified exists.", "Try acquiring media with fewer constraints."];
        ...
        14: [function (require, module, exports) {
            ...
            EventPublisher.prototype._post = function _post(endpointName, level, group, name, payload, connection, force) {
                ...
                var requestParams = {
                    ...
                    body: event,
                    headers: {"Content-Type": "application/json", "X-Twilio-Token": this.token}
                };
        ...
        17: [function (require, module, exports) {
            ...
            var _a = require("../constants"), COWBELL_AUDIO_URL = _a.COWBELL_AUDIO_URL,
            ...
            var PreflightTest = function (_super) {
                ...
                function PreflightTest(token, options) {
                    ...
                    _this._initDevice(token, __assign(__assign({}, _this._options), {fileInputStream: _this._options.fakeMicInput ? _this._getStreamFromFile() : undefined}));
                    return _this
                }
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    ...
                                    _a = this;
                                    return [4, this._device.connect({rtcConfiguration: this._options.rtcConfiguration})];
                                case 1:
                                    _a._call = _b.sent();
            ...
            exports.PreflightTest = PreflightTest
        }, {"../call": 6, "../constants": 7, "../device": 9, "../errors": 12, "../rtc/stats": 29, events: 48}],
        18: [function (require, module, exports) {
            ...
            var _require = require("./errors"), GeneralErrors = _require.GeneralErrors,
            ...
            var PStream = function (_EventEmitter) {
                ...
                function PStream(token, uris, options) {
                    ...
                    var defaults = {TransportFactory: WSTransport};
                    options = options || {};
            ...
            PStream.prototype._handleTransportMessage = function (msg) {
                ...
                var _JSON$parse = JSON.parse(msg.data), type = _JSON$parse.type,
            ...
            function getBrowserInfo() {
                ...
                var info = {
                    p: "browser",
                    v: C.RELEASE_VERSION,
                    browser: {userAgent: nav.userAgent || "unknown", platform: nav.platform || "unknown"},
                    plugin: "rtc"
                };
                return info
            }
        ...
        }, {"./constants": 7, "./errors": 12, "./log": 15, "./wstransport": 36, events: 48}],
        ...
        23: [function (require, module, exports) {
            ...
            var _require = require("./rtcpc"), test = _require.test;
        ...
        25: [function (require, module, exports) {
            ...
            exports.default = {calculate: calculate, isNonNegativeNumber: isNonNegativeNumber}
        }, {}],
        26: [function (require, module, exports) {
            "use strict";
            var _require = require("../errors"), InvalidArgumentError = _require.InvalidArgumentError,
                MediaErrors = _require.MediaErrors, NotSupportedError = _require.NotSupportedError,
                SignalingErrors = _require.SignalingErrors;
            var Log = require("../log").default;
            var util = require("../util");
            var RTCPC = require("./rtcpc");
            var _require2 = require("./sdp"), setIceAggressiveNomination = _require2.setIceAggressiveNomination;
            ...
            PeerConnection.prototype._createAnalyser = function (audioContext, options) {
                options = Object.assign({fftSize: 32, smoothingTimeConstant: .3}, options);
        ...
        }, {"../errors": 12, "../log": 15, "../util": 35, "./rtcpc": 27, "./sdp": 28}],
        27: [function (require, module, exports) {
            (function (global) {
                (function () {
                    ...
                    var Log = require("../log").default;
                    var _require = require("./sdp"), setCodecPreferences = _require.setCodecPreferences,
        ...
        }, {"../log": 15, "../util": 35, "./sdp": 28, "rtcpeerconnection-shim": 56}],
        28: [function (require, module, exports) {
            ...
            function getPreferredCodecInfo(sdp) {
                var _ref = /a=rtpmap:(\d+) (\S+)/m.exec(sdp) || [null, "", ""], _ref2 = _slicedToArray(_ref, 3),
                    codecId = _ref2[1], codecName = _ref2[2];
                var regex = new RegExp("a=fmtp:" + codecId + " (\\S+)", "m");
                var _ref3 = regex.exec(sdp) || [null, ""], _ref4 = _slicedToArray(_ref3, 2), codecParams = _ref4[1];
        ...
        29: [function (require, module, exports) {
            ...
            var _a = require("../errors"), NotSupportedError = _a.NotSupportedError,
            ...
            function getRTCIceCandidateStatsReport(peerConnection) {
                return getRTCStatsReport(peerConnection).then(function (report) {
                    var _a = Array.from(report.values()).reduce(function (rval, stat) {
                            ...
                            return rval
                        }, {}), candidatePairs = _a.candidatePairs, localCandidates = _a.localCandidates,
                        remoteCandidates = _a.remoteCandidates, transport = _a.transport;
            ...
            module.exports = {getRTCStats: getRTCStats, getRTCIceCandidateStatsReport: getRTCIceCandidateStatsReport}
        ...
        32: [function (require, module, exports) {
            ...
            var MediaDevicesShim = function (_super) {
        ...
        33: [function (require, module, exports) {
            ...
            function Sound(name, url, options) {
                ...
                Object.defineProperties(this, {
                    ...
                    _isSinkSupported: {value: options.AudioFactory !== null && typeof options.AudioFactory.prototype.setSinkId === "function"},
        ...
        34: [function (require, module, exports) {
            ...
            var DEFAULT_THRESHOLDS = {
                ...
                jitter: {max: 30},
                mos: {min: 3},
                packetsLostFraction: [{max: 1}, {clearValue: 1, maxAverage: 3, sampleCount: 7}],
                rtt: {max: 400}
            };
            ...
            var StatsMonitor = function (_super) {
                ...
                function StatsMonitor(options) {
                    ...
                    _this._sampleBuffer = [];
                    _this._supplementalSampleBuffers = {audioInputLevel: [], audioOutputLevel: []};
                ...
                StatsMonitor.prototype._clearWarning = function (statName, thresholdName, data) {
                    ...
                    this.emit("warning-cleared", __assign(__assign({}, data), {
                        name: statName,
                        threshold: {name: thresholdName, value: this._thresholds[statName][thresholdName]}
                    }))
                };
        ...
        }, {"./errors": 12, "./rtc/mos": 25, "./rtc/stats": 29, "./util": 35, events: 48}],
        ...
        36: [function (require, module, exports) {
            ...
            var WSTransport = function (_super) {
                ...
                function WSTransport(uris, options) {
                    ...
                    _this._backoffStartTime = {preferred: null, primary: null};
                ...
                WSTransport.prototype._setupBackoffs = function () {
                    ...
                    var primaryBackoffConfig = {
                        factor: 2,
                        initialDelay: this._uris && this._uris.length > 1 ? Math.floor(Math.random() * (5e3 - 1e3 + 1)) + 1e3 : 100,
                    ...
                    return {preferred: preferredBackoff, primary: primaryBackoff}
                };
        ...
        37: [function (require, module, exports) {
            ...
            var AudioPlayer = function (_EventTarget_1$defaul) {
                ...
                _createClass(AudioPlayer, [{
                    ...
                    key: "srcObject", get: function get() {
        ...
        }, {"./Deferred": 38, "./EventTarget": 39, "babel-runtime/regenerator": 41}],
        ...
        }, {"./backoff": 43, "./strategy/fibonacci": 46, events: 48, precond: 50, util: 60}],
        ...
        57: [function (require, module, exports) {
            ...
            SDPUtils.parseSsrcGroup = function (line) {
                ...
                return {
                    semantics: parts.shift(), ssrcs: parts.map(function (ssrc) {
